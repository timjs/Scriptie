...
\placefigure[][fig:simulaties aantal]
  ...
  {\externalfigure[simulatie-28-30] [width=0.5\textwidth]} {a\quad $l=28$ en $N=30$}
...
\placefigure[][fig:simulaties massa]
  {}
  \startcombination[2*1]
  {\externalfigure[simulatie-14-15]        [width=0.5\textwidth]} {a\quad Massa in orde van elektron}
  {\externalfigure[simulatie-14-15-bigmass][width=0.5\textwidth]} {b\quad Massa in orde van kilogrammen}
  \stopcombination
