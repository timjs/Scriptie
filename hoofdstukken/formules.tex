...
Bij de berekeningen in \see[chp:normalisatie] maken we gebruik van \emph{Fresnelintegralen}. Dit zijn de functies $\fres[z]$ en $\frec[z]$. Ze zijn gedefinieerd als een integraal over respectievelijk de sinus en de cosinus van $\halfpi t^2$. De integratiegrenzen lopen van nul tot aan het argument $z$:
...
Fresnelintegralen kunnen we gebruiken bij het integreren van niet triviale exponenten. Zo komen we in \see[sec:afleiding] een kwadratische functie tegen in een exponent. Deze Gaussische functie is op te lossen met de identiteit
