...
reflectionPoints = Table[{-(plateLength/2) + n* pointDistance, 0}, {n, 0, numberOfPaths}];

(* ::Subsection:: *)
(*Paden*)

paths = {sourcePosition, #, detectorPosition}& /@ reflectionPoints;
pathLengths = EuclideanDistance[sourcePosition, #]  +  EuclideanDistance[#, detectorPosition]& /@ reflectionPoints;
...
ListLinePlot[{phasorPoints, resultPoints}, 
  PlotStyle -> {RGBColor[0.996, 0.800, 0.620], Directive[Orange, Thick]}, 
